...
function useMobilePreviewMode() {
    ...
    useEffect(() => {
        ...
        const update = () => setEnabled(mqTouch.matches || mqSmall.matches)
...
export default function Projects() {
    ...
    const mobilePreviewMode = useMobilePreviewMode()
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
                    <div className="lg:col-span-7">
                        ...
                        <div
                            ...
                            onMouseLeave={() => {
                                if (!mobilePreviewMode) setActiveIdx(null)
                            }}
                        >                            {projects.map((p, idx) => {
                            ...
                            return (
                                <div key={p.slug} style={itemVars}>
                                    <Link
                                        to={mobilePreviewMode && activeIdx !== idx ? "#" : `/projects/${p.slug}`}
                                        onClick={(e) => {
                                            if (mobilePreviewMode && activeIdx !== idx) {
                                                e.preventDefault()
                                                setActiveIdx(idx)
                                            }
                                        }}
                                        onMouseEnter={() => {
                                            if (!mobilePreviewMode) setActiveIdx(idx)
                                        }}
                                        ...
                                        <Link to={`/projects/${p.slug}`} className="block">
                                            <div
                                                ...
                                                <div className="relative aspect-[4/5] w-full">
                                                    <div className="absolute inset-0"
                                                         style={{backgroundImage: previewBg(t)}}/>
                            ...
                            />
                                                    ...
                                                    <div className="absolute left-5 right-5 bottom-5">
                                                        <div
                                                            className="text-[clamp(18px,2.3vw,22px)] text-white/92">{p.title}</div>
                                                        ...
                                                        <div className="mt-4 flex items-center justify-between">
                                                            <div
                                                                className="text-[12px] uppercase tracking-[0.22em] text-white/80">
                                                                Open project →
                                                            </div>
