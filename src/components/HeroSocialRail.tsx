export default function HeroSocialRail() {
    const items = [
        ...
        },
        {
            ...
            svg: (
                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                    <path d="M20.45 20.45h-3.55v-5.56c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.66H9.32V9h3.41v1.56h.05c.47-.9 1.63-1.85 3.36-1.85 3.6 0 4.26 2.37 4.26 5.45v6.29ZM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12Zm-1.78 13.02h3.56V9H3.56v11.45Z" />
                </svg>
            )
        },
        {
            ...
            svg: (
                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
                    <path d="M4 7.2c0-.42.16-.81.44-1.1L6 4.6h.23l5.5 12.25 4.84-12.25H17l1.74 1.5c.3.23.46.6.41.98v9.84c.05.38-.11.75-.41.98L17.1 19.4H17l-5.52-12.6L7.77 19.4H7.54L4.44 16.9A1.2 1.2 0 0 1 4 15.8V7.2Z" />
                </svg>
            )
        },
        {
    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-[9999]">
            ...
            >
                <div className="pointer-events-auto flex items-center gap-2 rounded-full border border-white/10 bg-black/30 px-2 py-1.5 backdrop-blur-sm lg:flex-col lg:gap-4 lg:rounded-none lg:border-0 lg:bg-transparent lg:px-0 lg:py-0">
                    {items.map((it, idx) => (
                        <div key={it.label} className="flex items-center lg:flex-col">
                            ...
                            {idx !== items.length - 1 && <div className="hidden lg:block mt-2 h-px w-4 bg-white/30" />}
                        </div>
                    ))}
                </div>
            </div>
